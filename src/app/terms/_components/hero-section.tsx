...
export function HeroSection() {
	return (
		<article className="prose text-neutral-900 py-6">
			<h1 className="text-center text-neutral-900">Terms and Conditions</h1>
			<p>
				...
				terms and conditions (&quot;Terms of Service&quot;). These Terms of
				Service apply to all users of the site. Any new features or tools which
				are added to current store shall also be subject to the Terms of
				Service.
				<br />
				<br />
